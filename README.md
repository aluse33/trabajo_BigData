...
La versión final del trabajo puede visualizarse en: <https://aluse33.github.io/trabajo_BigData/>. 


<!-- Abajo podéis escribir lo que queráis, igual un resumen del trabajo, o ..., o ... pero al menos, tenéis que poner el título del trabajo y el nombre de los componentes del equipo-->

El autor del trabajo soy yo,  Alejandro Lucas Serrano (aluse@alumni.uv.es).

El título del trabajo es "Arreglando la Economía Española como no lo haría un economista (o cinco excusas para programar)"
